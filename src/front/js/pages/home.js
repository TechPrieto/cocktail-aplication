	...
	<div className="container py-5">
		<div className="row d-flex align-items-center">
			<div className="col-sm-12 col-md-6">
				...
				<p className="left text-center">The Drink Link users will be able to search for many drink recipes by liqour type, drink style, and ingredient count. We also proudly offer our registered users the ability to save recipes for later, generate a shopping list based on chosen recipes. Sign up today!</p>
		...
		<div className="d-flex justify-content-center align-items-center row">
			...
			<Link to="/bussines" className="col-sm-12 col-lg-4 text-decoration-none p-0">
				<div className="card3 boxBussines col-sm-12 col-lg-4 container border rounded mt-4 mb-4 joshstyles2 col-12 text-center" style={{ width: '400px', height: 'auto', boxShadow: '1px 4px 19px #0F0C22' }}>
					...
					<h2 className="left text-center mb-3" style={{ color: '#0F0C24' }}>Business consulting</h2>

					<p className="left text-center" style={{ color: '#0F0C24' }}>Are you opening a bar or your bar is going down? Let the experts help you</p>
					<Link to="/bussines">
						<button className="button text-center m-2 mt-4" style={{ backgroundColor: '#C1436D', border: 'none' }}>Click here</button>
					</Link>
				</div>
			</Link>
			...
			<Link to="/bussines" className="col-sm-12 col-lg-4 text-decoration-none p-0"><div className="card3 boxBussines col-sm-12 col-lg-4 container border rounded mt-4 mb-4 joshstyles2 random-drink col-12 text-center" style={{ width: '400px', height: 'auto', boxShadow: '1px 4px 19px #0F0C22' }}>
				...
				<h2 className="left text-center  mb-3" style={{ color: '#0F0C24' }}>Your shopping list</h2>

				<p className="left text-center" style={{ color: '#0F0C24' }}>Get ready for friday night</p>
				<Link to="/shoppinglist">
					<button className="button text-center m-2 mt-5" style={{ backgroundColor: '#C1436D', border: 'none' }}>Check it here</button>
				</Link>
			</div>
			</Link>
		...
		<h2 id='drinks' className="left text-center " style={{ marginTop: "4.5rem" }}>Popular Drinks</h2>
