                ...
                return (
                    <div className="container">
                        <div className="borderShopping m-5">
                            <table >
                                <buttom className="button" onClick={() => actions.deleteList(list)}>delete recipe</buttom>
                                <thead>
                                    <tr>
                                        <th className="text-center border-bottom border-dark w-100 ms-1" ><h3 key={i}>{item.strDrink}</h3></th>
                                    </tr>
                                </thead>
